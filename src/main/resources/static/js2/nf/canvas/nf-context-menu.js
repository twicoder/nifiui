...
nf.ContextMenu = (function () {
    ...
    var actions = [
        {condition: emptySelection, menuItem: {img: '/static/images/iconRefresh.png', text: 'Refresh status', action: 'reloadStatus'}},
        {condition: isNotRootGroup, menuItem: {img: '/static/images/iconGoTo.png', text: 'Leave group', action: 'leaveGroup'}},
        {condition: isConfigurable, menuItem: {img: '/static/images/iconConfigure.png', text: 'Configure', action: 'showConfiguration'}},
        {condition: hasDetails, menuItem: {img: '/static/images/iconConfigure.png', text: 'View configuration', action: 'showDetails'}},
        {condition: isProcessGroup, menuItem: {img: '/static/images/iconGoTo.png', text: 'Enter group', action: 'enterGroup'}},
        {condition: isRunnable, menuItem: {img: '/static/images/iconRun.png', text: 'Start', action: 'start'}},
        {condition: isStoppable, menuItem: {img: '/static/images/iconStop.png', text: 'Stop', action: 'stop'}},
        {condition: isRemoteProcessGroup, menuItem: {img: '/static/images/iconRemotePorts.png', text: 'Remote ports', action: 'remotePorts'}},
        {condition: canStartTransmission, menuItem: {img: '/static/images/iconTransmissionActive.png', text: 'Enable transmission', action: 'enableTransmission'}},
        {condition: canStopTransmission, menuItem: {img: '/static/images/iconTransmissionInactive.png', text: 'Disable transmission', action: 'disableTransmission'}},
        {condition: supportsStats, menuItem: {img: '/static/images/iconChart.png', text: 'Stats', action: 'showStats'}},
        {condition: canMoveToFront, menuItem: {img: '/static/images/iconToFront.png', text: 'Bring to front', action: 'toFront'}},
        {condition: isConnection, menuItem: {img: '/static/images/iconGoTo.png', text: 'Go to source', action: 'showSource'}},
        {condition: isConnection, menuItem: {img: '/static/images/iconGoTo.png', text: 'Go to destination', action: 'showDestination'}},
        {condition: hasUpstream, menuItem: {img: '/static/images/iconSmallRelationship.png', text: 'Upstream connections', action: 'showUpstream'}},
        {condition: hasDownstream, menuItem: {img: '/static/images/iconSmallRelationship.png', text: 'Downstream connections', action: 'showDownstream'}},
        {condition: hasUsage, menuItem: {img: '/static/images/iconUsage.png', text: 'Usage', action: 'showUsage'}},
        {condition: isRemoteProcessGroup, menuItem: {img: '/static/images/iconRefresh.png', text: 'Refresh flow', action: 'refreshRemoteFlow'}},
        {condition: isRemoteProcessGroup, menuItem: {img: '/static/images/iconGoTo.png', text: 'Go to', action: 'openUri'}},
        {condition: isColorable, menuItem: {img: '/static/images/iconColor.png', text: 'Change color', action: 'fillColor'}},
        {condition: isNotConnection, menuItem: {img: '/static/images/iconCenterView.png', text: 'Center in view', action: 'center'}},
        {condition: isCopyable, menuItem: {img: '/static/images/iconCopy.png', text: 'Copy', action: 'copy'}},
        {condition: isPastable, menuItem: {img: '/static/images/iconPaste.png', text: 'Paste', action: 'paste'}},
        {condition: isDeletable, menuItem: {img: '/static/images/iconDelete.png', text: 'Delete', action: 'delete'}}
    ];
