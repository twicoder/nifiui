        ...
        port.append('image')
                ...
                .attr({
                    'xlink:href': function (d) {
                        if (d.component.type === 'INPUT_PORT') {
                            return '/static/images/iconInputPort.png';
                        } else {
                            return '/static/images/iconOutputPort.png';
                        }
                    },
                    'width': 46,
                    'height': 31,
                ...
                details.select('image.port-run-status-icon')
                        .attr('xlink:href', function (d) {
                            ...
                            if (d.component.state === 'DISABLED') {
                                img = '/static/images/iconDisable.png';
                                ...
                                img = '/static/images/iconStop.png';
                            }
                            return img;
                        })
                        .each(function (d) {
        ...
        updated.select('image.port-transmission-icon')
                .attr('xlink:href', function (d) {
                    if (d.status.transmitting === true) {
                        return '/static/images/iconPortTransmitting.png';
                    } else {
                        return '/static/images/iconPortNotTransmitting.png';
                    }
                });
