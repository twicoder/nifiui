...
nf.ProcessGroup = (function () {
    ...
    var renderProcessGroups = function (entered, selected) {
        ...
        processGroup.append('image')
                ...
                .attr({
                    'xlink:href': '/static/images/bgProcessGroupDetailsArea.png',
                    'width': 352,
                    'height': 113,
                    'x': 6,
                    'y': 22,
            ...
            if (processGroup.classed('visible')) {
                if (details.empty()) {
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconRun.png',
                                'width': 16,
                                'height': 16,
                                'y': 25,
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconStop.png',
                                'width': 16,
                                'height': 16,
                                'y': 25,
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconAlert.png',
                                'width': 16,
                                'height': 16,
                                'y': 25,
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconDisable.png',
                                'width': 16,
                                'height': 16,
                                'y': 25,
