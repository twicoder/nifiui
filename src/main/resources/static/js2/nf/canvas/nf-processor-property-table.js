    ...
    var initProcessorPropertiesTable = function () {
        ...
        var nameFormatter = function (row, cell, value, columnDef, dataContext) {
            ...
            if (nf.Common.isDefinedAndNotNull(propertyDescriptor)) {
                if (!nf.Common.isBlank(propertyDescriptor.description) || !nf.Common.isBlank(propertyDescriptor.defaultValue) || !nf.Common.isBlank(propertyDescriptor.supportsEl)) {
                    $('<img class="icon-info" src="/static/images/iconInfo.png" alt="Info" title="" style="float: right; margin-right: 6px; margin-top: 4px;" />').appendTo(cellContent);
        ...
        var actionFormatter = function (row, cell, value, columnDef, dataContext) {
            ...
            if (dataContext.type === 'userDefined') {
                markup = '<img src="/static/images/iconDelete.png" title="Delete" class="pointer" style="margin-top: 2px" onclick="javascript:nf.ProcessorPropertyTable.deleteProperty(\'' + row + '\');"/>';
            }
