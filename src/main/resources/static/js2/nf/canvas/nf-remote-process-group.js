...
nf.RemoteProcessGroup = (function () {
    ...
    var renderRemoteProcessGroups = function (entered, selected) {
        ...
        remoteProcessGroup.append('image')
                ...
                .attr({
                    'xlink:href': '/static/images/bgRemoteProcessGroupDetailsArea.png',
                    'width': 352,
                    'height': 89,
                    'x': 6,
                    'y': 38,
            ...
            if (remoteProcessGroup.classed('visible')) {
                if (details.empty()) {
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconInputPortSmall.png',
                                'width': 16,
                                'height': 16,
                                'x': 10,
                                'y': 41
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconTransmissionActive.png',
                                'width': 16,
                                'height': 16,
                                'y': 41,
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconTransmissionInactive.png',
                                'width': 16,
                                'height': 16,
                                'y': 41,
                    ...
                    details.append('image')
                            .call(nf.CanvasUtils.disableImageHref)
                            .attr({
                                'xlink:href': '/static/images/iconOutputPortSmall.png',
                                'width': 16,
                                'height': 16,
                                'x': 186,
                                'y': 41,
                    ...
                    details.append('image')
                            ...
                            .attr({
                                'class': 'bulletin-icon',
                                'xlink:href': '/static/images/iconBulletin.png',
                                'width': 12,
                                'height': 12,
                                'y': 2
                            });
                ...
                details.select('image.remote-process-group-transmission-status')
                        .attr('xlink:href', function (d) {
                            ...
                            if (nf.Common.isDefinedAndNotNull(d.status) && !nf.Common.isEmpty(d.status.authorizationIssues)) {
                                img = '/static/images/iconAlert.png';
                            } else if (d.component.transmitting === true) {
                                img = '/static/images/iconTransmissionActive.png';
                            } else {
                                img = '/static/images/iconTransmissionInactive.png';
                            }
                            return img;
                        })
                        .each(function (d) {
                ...
                details.select('image.remote-process-group-transmission-secure')
                        .attr('xlink:href', function (d) {
                            ...
                            if (d.component.targetSecure === true) {
                                img = '/static/images/iconSecure.png';
                            } else {
                                img = '/static/images/iconNotSecure.png';
                            }
                            return img;
                        })
                        .each(function (d) {
